...
{
	// Properties
	public List<Vector2> SamplingPoints { get; private set; }

	// Constructor
	public PoissonDiscSampling(float radius, Vector2 sampleRegionSize, int numSamplesBeforeRejection)
    {
		SamplingPoints = GeneratePoints(radius, sampleRegionSize, numSamplesBeforeRejection);
    }
